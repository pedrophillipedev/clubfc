  ...
  var startSlider = $("#lightSlider").lightSlider({
    ...
    onBeforeStart: function () {
      var slideContent = [
        {
          heading:
            'Soluções pra facilitar<br> a vida da sua <span class="main-title__blue-background">empresa</span>.',
          subHeading:
            "Nosso negócio é criar e desenvolver soluções que entregam eficiência à sua empresa para uma gestão assertiva e estratégica.",
          btn:
            '<a href="/produtos" class="main-title-link u-mobile-display-block"> <span class="main-title-link__strip">&nbsp;</span> Encontre a solução certa para seu negócio</a>',
        },
        {
          heading:
            // 'Delivery, comanda e mesa <span class="main-title__blue-background">controlados</span> por você, na palma da sua mão.',
            'Opytex <span class="main-title__blue-background">Gourmet</span>.',
          subHeading:
            "Controle os consumos por Mesa/Comanda/Delivery com função para Fast Food e automatize o envio para produção. Obtenha informações exatas das taxas e comissões por Garçom e Entregador.",
          btn:
        ...
        },
        {
          ...
          heading:
            'Opytex <span class="main-title__blue-background">Gestor</span>.',
          subHeading:
            "Gerencie sua empresa ou rede de loja de qualquer lugar, online e/ou offline. Administre seus documentos fiscais (NF-e/NFC-e/MDF-e ou SAT) na nuvem.",
          btn:
